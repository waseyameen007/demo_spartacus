(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@nguniversal/common/engine'), require('@nguniversal/express-engine/tokens')) :
    typeof define === 'function' && define.amd ? define('@nguniversal/express-engine', ['exports', '@nguniversal/common/engine', '@nguniversal/express-engine/tokens'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global.nguniversal = global.nguniversal || {}, global.nguniversal.expressEngine = {}), global.nguniversal.common.engine, global.nguniversal.expressEngine.tokens));
}(this, (function (exports, engine, tokens) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    function ngExpressEngine(setupOptions) {
        var engine$1 = new engine.CommonEngine(setupOptions.bootstrap, setupOptions.providers);
        return function (filePath, options, callback) {
            ...
            try {
                ...
                renderOptions.providers = __spreadArray(__spreadArray([], __read((renderOptions.providers || []))), [getReqResProviders(req, res)]);
