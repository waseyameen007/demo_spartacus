...
import { ReturnRequestList, TranslationService } from '@spartacus/core';
...
export declare class OrderReturnRequestListComponent implements OnDestroy {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<OrderReturnRequestListComponent, "cx-order-return-request-list", never, {}, {}, never, never>;
}
