...
export declare class ItemCounterComponent implements OnInit, OnDestroy {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<ItemCounterComponent, "cx-item-counter", never, { "control": "control"; "min": "min"; "max": "max"; "step": "step"; "allowZero": "allowZero"; "readonly": "readonly"; }, {}, never, never>;
}
