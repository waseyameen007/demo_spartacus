...
export declare class DeleteSavedCartEvent extends SavedCartEvent {
    /**
     * Event's type
     */
    static readonly type = "DeleteSavedCartEvent";
}
export declare class DeleteSavedCartSuccessEvent extends SavedCartEvent {
    /**
     * Event's type
     */
    static readonly type = "DeleteSavedCartSuccessEvent";
}
export declare class DeleteSavedCartFailEvent extends SavedCartEvent {
    /**
     * Event's type
     */
