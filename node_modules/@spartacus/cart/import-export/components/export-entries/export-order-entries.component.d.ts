...
import { ContextService, OrderEntriesContext } from '@spartacus/storefront';
...
export declare class ExportOrderEntriesComponent {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<ExportOrderEntriesComponent, "cx-export-order-entries", never, {}, {}, never, never>;
}
