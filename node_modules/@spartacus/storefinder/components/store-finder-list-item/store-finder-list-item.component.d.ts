...
export declare class StoreFinderListItemComponent extends AbstractStoreItemComponent {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<StoreFinderListItemComponent, "cx-store-finder-list-item", never, { "locationIndex": "locationIndex"; "listOrderLabel": "listOrderLabel"; "displayDistance": "displayDistance"; "useClickEvent": "useClickEvent"; }, { "storeItemClick": "storeItemClick"; }, never, never>;
}
