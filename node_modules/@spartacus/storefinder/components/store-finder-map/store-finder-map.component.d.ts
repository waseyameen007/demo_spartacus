...
export declare class StoreFinderMapComponent implements OnChanges {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<StoreFinderMapComponent, "cx-store-finder-map", never, { "locations": "locations"; }, { "selectedStoreItem": "selectedStoreItem"; }, never, never>;
}
