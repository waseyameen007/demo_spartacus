...
import { Cart, PaymentType, StateUtils } from '@spartacus/core';
...
export declare class LoadPaymentTypes extends StateUtils.EntityLoadAction {
    readonly type = "[Checkout] Load Payment Types";
    constructor();
}
export declare class LoadPaymentTypesFail extends StateUtils.EntityFailAction {
    payload: any;
    readonly type = "[Checkout] Load Payment Types Fail";
    constructor(payload: any);
}
export declare class LoadPaymentTypesSuccess extends StateUtils.EntitySuccessAction {
    payload: PaymentType[];
    readonly type = "[Checkout] Load Payment Types Success";
    constructor(payload: PaymentType[]);
}
export declare class ResetLoadPaymentTypesProcess extends StateUtils.EntityLoaderResetAction {
