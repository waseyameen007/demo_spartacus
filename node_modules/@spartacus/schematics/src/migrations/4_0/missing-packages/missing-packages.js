...
const missing_packages_1 = require("../../mechanism/missing-packages/missing-packages");
const MISSING_PACKAGE_DATA = [
    {
...
function migrate() {
    return (tree, context) => {
        for (const migrationData of MISSING_PACKAGE_DATA) {
            missing_packages_1.migrateMissingPackage(tree, context, migrationData);
        }
    };
}
