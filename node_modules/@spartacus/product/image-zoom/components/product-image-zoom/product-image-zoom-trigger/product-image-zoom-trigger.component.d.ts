...
export declare class ProductImageZoomTriggerComponent implements OnDestroy {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<ProductImageZoomTriggerComponent, "cx-product-image-zoom-trigger", never, { "galleryIndex": "galleryIndex"; "expandImage": "expandImage"; }, { "dialogClose": "dialogClose"; }, never, never>;
}
