...
export declare class ProductVariantSizeSelectorComponent {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<ProductVariantSizeSelectorComponent, "cx-product-variant-size-selector", never, { "product": "product"; "variants": "variants"; }, {}, never, never>;
}
