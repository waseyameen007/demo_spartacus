...
export declare class ProductVariantColorSelectorComponent {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<ProductVariantColorSelectorComponent, "cx-product-variant-color-selector", never, { "product": "product"; "variants": "variants"; }, {}, never, never>;
}
